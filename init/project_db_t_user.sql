...
CREATE TABLE `t_user` (
  ...
  `age` varchar(45) DEFAULT NULL COMMENT '用户年龄',
  `sex` varchar(1) NOT NULL DEFAULT '男' COMMENT '用户性别',
  `expiration_date` date DEFAULT NULL COMMENT '会员到期时间',
  `head_img` varchar(200) DEFAULT NULL COMMENT '头像链接',
  `phone_num` varchar(11) DEFAULT NULL COMMENT '用户电话号码',
  PRIMARY KEY (`id`),
